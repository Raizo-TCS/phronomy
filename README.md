...
| **`Phronomy::Metrics`** — `Phronomy::Metrics.snapshot` reports `offload_pool_active`, `offload_pool_queue_length`, `offload_pool_abandoned_active`, `offload_pool_abandoned_total`, `offload_pool_size`, plus EventLoop queue/lag metrics | Beta |
