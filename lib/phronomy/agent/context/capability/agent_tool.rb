  ...
  module Agent
    module Context
      module Capability
        ...
        #   SummarizerTool = Phronomy::Agent::Context::Capability::AgentTool.from_agent(
        #     SummarizerAgent,
        #     tool_name:   "summarize",
        ...
        #   end
        class AgentTool < Phronomy::Agent::Context::Capability::Base
          description "Wraps an agent as a tool"
          param :input, type: :string, desc: "The input to forward to the wrapped agent"

          class << self
            # Generates a Phronomy::Agent::Context::Capability::AgentTool subclass that delegates #execute to
            ...
            # @return [Class] an anonymous Phronomy::Agent::Context::Capability::AgentTool subclass
            # @api public
