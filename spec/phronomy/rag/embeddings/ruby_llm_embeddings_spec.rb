...
RSpec.describe Phronomy::RAG::Embeddings::RubyLLMEmbeddings do
  ...
  describe "inheritance" do
    it "inherits from Phronomy::RAG::Embeddings::Base" do
      expect(described_class.ancestors).to include(Phronomy::RAG::Embeddings::Base)
    end
  end
end
