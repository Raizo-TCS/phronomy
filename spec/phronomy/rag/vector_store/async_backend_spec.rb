...
RSpec.describe "VectorStore::AsyncBackend (Issue #304)" do
  ...
  describe "native async override" do
    let(:native_store_class) do
      Class.new(Phronomy::RAG::VectorStore::Base) do
        include Phronomy::RAG::VectorStore::AsyncBackend
  ...
  describe "Phronomy::RAG::VectorStore::Base" do
    it "includes AsyncBackend" do
      expect(Phronomy::RAG::VectorStore::Base.ancestors).to include(Phronomy::RAG::VectorStore::AsyncBackend)
    end
  ...
  describe "InMemory backward compatibility" do
    let(:store) do
      s = Phronomy::RAG::VectorStore::InMemory.new(dimension: 2)
