...
RSpec.describe Phronomy::Embeddings::RubyLLMEmbeddings do
  ...
  describe "inheritance" do
    it "inherits from Phronomy::Embeddings::Base" do
      expect(described_class.ancestors).to include(Phronomy::Embeddings::Base)
    end
  end
end
