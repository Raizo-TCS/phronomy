...
RSpec.describe "VectorStore::AsyncBackend (Issue #304)" do
  ...
  describe "Phronomy::Agent::Context::Knowledge::VectorStore::Base" do
    it "includes AsyncBackend" do
      expect(Phronomy::Agent::Context::Knowledge::VectorStore::Base.ancestors).to include(Phronomy::Agent::Context::Knowledge::VectorStore::AsyncBackend)
    end
  ...
  describe "InMemory backward compatibility" do
    let(:store) do
      s = Phronomy::Agent::Context::Knowledge::VectorStore::InMemory.new(dimension: 2)
