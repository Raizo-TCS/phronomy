...
RSpec.describe Phronomy::Agent::Context::Knowledge::VectorStore::RedisSearch do
  before do
  ...
  describe "inheritance" do
    it "inherits from Phronomy::Agent::Context::Knowledge::VectorStore::Base" do
      expect(described_class.ancestors).to include(Phronomy::Agent::Context::Knowledge::VectorStore::Base)
    end
  end
