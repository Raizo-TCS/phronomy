...
RSpec.describe Phronomy::Agent::Context::Knowledge::Embeddings::RubyLLMEmbeddings do
  ...
  describe "inheritance" do
    it "inherits from Phronomy::Agent::Context::Knowledge::Embeddings::Base" do
      expect(described_class.ancestors).to include(Phronomy::Agent::Context::Knowledge::Embeddings::Base)
    end
  end
end
