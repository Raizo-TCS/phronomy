...
| [`014-unified-persistence-durable-state`](014-unified-persistence-durable-state.md) | Accepted | Yes | Current except Workflow identity terminology superseded by ADR-020, generic `InvocationContext` / Agent correlation semantics superseded by ADR-021, and concrete FSMSession/Agent-Tool routing identity superseded by ADR-023; Workflow admission-owner, terminal-save, and ACS-11 ownership reconciliation remain separate work. |
...
| [`022-agent-execution-parent-identity-and-runtime-routing-boundary`](022-agent-execution-parent-identity-and-runtime-routing-boundary.md) | Accepted | Yes | Canonicalizes Agent-owned Tool/approval logical parent as `execution_id`; CG-03a is reconciled and ADR-023 implements the CG-03b identity/routing slice. Final CG-03 closure remains coupled to ACS-11 result authority. |
| [`023-fsm-session-incarnation-identity-and-routing`](023-fsm-session-incarnation-identity-and-routing.md) | Accepted | Yes | FSMSession-owned incarnation identity, session-local Agent/Tool/Multi-Agent routing, stale-target drop, and the transitional Workflow identity-reservation bridge. ACS-11 and ACS-13 remain separate follow-ups. |
