# Migration to 0.22: semantic Multi-Agent Handoff

Phronomy 0.22 changes Multi-Agent Handoff from Tool-result/sentinel routing to an
explicit framework control-transfer model. This is a clean break: compatibility
